<template>
  <main v-if="!loading" class=" min-h-full mx-10 grid grid-flow-row grid-cols-2 auto-rows-auto gap-10">
    <div v-for="post in posts" :key="post.id" class="content ">
      ...
      <p @click="persist(post.id)" class="my-3 cursor-pointer underline italic"> <a>Read More</a></p>
